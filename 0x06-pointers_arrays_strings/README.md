...
task 9 - a function that encodes a string using rot13.
...
task 11 - Add one line to this code, so that the program prints a[2] = 98, followed by a new line.
...
task 12 -  a function that adds two numbers.
...
task 13 - a function that prints a buffer.
