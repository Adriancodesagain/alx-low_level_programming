...
task 15 - By considering the terms in the Fibonacci sequence whose values do not exceed 4,000,000,these is a program that finds and prints the sum of the even-value		terms, followed by a new line.without use the standard library.
